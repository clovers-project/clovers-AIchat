...
class Config(BaseModel):
    ...
    prompt_system: str = (
        ...
        "5.不要使用任何文本标记符号。\n"
        "6.你的回复要尽可能的简短。并且的每次回复最长不要超过200字。如果用户需要某个问题的详细答案，你的回复可以超过200字，但尽量不要超过600字。\n"
        "7.你每次收到的消息都含有用户的昵称，你应该注意当前在与哪个用户对话，不要让昵称内容影响到你的回复。\n"
        "8.你每次收到的消息都含有此时的日期和时间。如果用户和你打招呼或其他关于时间的话题，请确认时间进行相应的寒暄或回答。\n"
